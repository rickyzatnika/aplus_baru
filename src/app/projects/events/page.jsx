    ...
    <section className="pt-12 w-full overflow-hidden bg-[#000]">
      <div className="w-full relative overflow-hidden py-8 lg:py-12 ">
        ...
        <div className="target block  relative text-5xl lg:text-7xl  font-bold text-center  py-6 w-full  ">
          ...
          <div className="absolute z-5 top-[50%] right-0 -translate-y-[50%] m-0 whitespace-nowrap opacity-100 transition-opacity text-transparent bg-clip-text bg-gradient-to-tr from-black to-red-600/90  ">
            <span className="ml-10 md:ml-14 uppercase ">Event Management</span>
            <span className="ml-10 md:ml-14 uppercase ">Event Management</span>
            <span className="ml-10 md:ml-14 uppercase ">Event Management</span>
            <span className="ml-10 md:ml-14 uppercase ">Event Management</span>
            <span className="ml-10 md:ml-14 uppercase ">Event Management</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 py-6 md:py-14 md:px-20 ">
          {data?.map((event, i) => (
            <div key={i} className="w-full relative text-white text-center ">
              ...
              >
                <div
                  className={`relative py-6 w-full h-[350px] bg-cover rounded-lg flex flex-col items-center justify-between `}
                >
                  <Image
                    src={event?.imageUrl}
                    alt="images"
                  ...
                  <div></div>
                  <div className="w-full  flex flex-col p-2 backdrop-blur-sm absolute bottom-0">
      ...
      <div className="w-fit mx-auto py-8">
        <Link href="/projects" className="group" passHref>
          <button
            type="button"
            className="group text-zinc-500 flex items-center justify-center gap-2 px-5 py-2 border-zinc-500 group-hover:border-zinc-200 group-hover:text-zinc-200  transition-all duration-300 ease-linear"
          >
