    ...
    <div className='w-full py-12 bg-white'>
      <div className='w-full md:w-[65%] px-4 md:px-20 flex flex-col gap-3 items-start'>
        <div className='flex flex-col gap-2 mb-5'>
          <h3 className='text-zinc-600  text-3xl'>{production?.title}</h3>
          ...
          <div className='flex items-center gap-3'>
            ...
            <p className='text-zinc-500 text-md'>{production?.place}</p>
          </div>
        </div>
        <Image src={production?.imageUrl} alt="image cover" width={800} height={400} className='object-cover py-8' />
        <p className='text-md md:text-lg leading-relaxed text-justify text-zinc-500'>{production?.content}</p>
      </div>
