      ...
      >
        ...
        <div className="w-full relative lg:w-5/6 mb-20 grid grid-cols-1 lg:grid-cols-12 mx-auto items-center  px-2 ">
          <div className="antialiased  col-span-1 lg:col-span-8 space-y-2 leading-relaxed">
            <h2 data-aos="fade-up" data-aos-duration="600" className="text-[#adadad] pb-2 text-xl lg:text-1xl  font-bold ">
              OUR PROJECTS
            </h2>
            <p data-aos="fade-up" data-aos-duration="700" className="textCustom font-bold text-5xl lg:text-6xl w-full lg:w-4/6 ">
